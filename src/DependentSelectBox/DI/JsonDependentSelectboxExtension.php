...
class JsonDependentSelectboxExtension extends CompilerExtension
{
	const BUTTON_SUFIX = '_submit';
	const CLASS_NAME = JsonDependentSelectBox::class;
	const EXTENSION_NAME = 'jsonDependentSelectbox';
	const METHOD_NAME = 'addJsonDependentSelectBox';
